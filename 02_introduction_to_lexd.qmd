...
Таким образом, в каждом файле `lexd` должен быть раздел `PATTERNS`, содержащий в себе переменные, которые могут быть заданы либо в разделе `PATTERN`, либо в разделе `LEXICON`, либо их анонимные варианты (см. раздел @sec-anonymous).
