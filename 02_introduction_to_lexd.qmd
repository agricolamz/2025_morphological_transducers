...
Ниже даны количественные и дистрибутивные (со значение 'по Х') числительные адыгейского языка (абхазо-адыгские) [@rogava1966: 79, 81]. Смоделируйте перечисленные формы:

| значение | лемма  | количественные | дистрибутивные |
|----------|--------|----------------|----------------|
| 1        | _зы_   | _зы_           | _зырыз_        |
| 3        | _щы_   | _щы_           | _щырыщ_        |
| 4        | _плIы_ | _плIы_         | _плIырыплI_    |
| 5        | _тфы_  | _тфы_          | _тфырытф_      |
| 6        | _хы_   | _хы_           | _хырых_        |
| 10       | _пшIы_ | _пшIы_         | _пшIырыпшI_    |
