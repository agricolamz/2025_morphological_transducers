...
```{{shell}}
$ echo "я играл" | hfst-proc -C analyzer.hfstol | vislcg3 -g cg_rules_1.rlx.bin
```

```{python}
!echo "я играл" | hfst-proc -C examples/analyzer.hfstol | vislcg3 -g examples/cg_rules_1.rlx.bin
```
