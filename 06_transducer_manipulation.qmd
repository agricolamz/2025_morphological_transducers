...
```{python}
!hfst-substitute -F examples/label_file.tsv -i examples/generator.hfst | hfst-fst2strings
```
...
```{python}
!lexd examples/correspondences.lexd | hfst-txt2fst -o examples/correspondences.hfst
...
```{python}
!lexd examples/correspondences.lexd | hfst-txt2fst | hfst-repeat -f 1 -o examples/correspondences.hfst
```
...
```{python}
!hfst-twolc -q examples/correspondences_twol.twol -o examples/correspondences_twol.hfst
!lexd examples/correspondences2.lexd | hfst-txt2fst | hfst-repeat -f 1 | hfst-compose-intersect examples/correspondences_twol.hfst -o examples/correspondences.hfst
...
$ hfst-compose ru_en.hfst correspondences.hfst | hfst-fst2strings
```

```{python}
!lexd examples/ru_en.lexd | hfst-txt2fst | hfst-repeat -f 1 -o examples/ru_en.hfst
