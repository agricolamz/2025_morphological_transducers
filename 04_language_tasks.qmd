...
В венгерском языке (угорские, фино-угорские) в нескольких корнях встречается метатеза, затрагивающая h и сонорный [@kenesei1998]. Она происходит перед несколькими показателями -*ek* <pl>, -*et* <acc> и -*en* <on><ess>. Диграф ly обозначает палатальный апроксимант [j].
...
| SG     | INS     | pikkel-lyel     | tüzér-rel     | kétel-lyel     | pehel-lyel    | teher-rel    | kehel-lyel    |
| SG     | PRP     | pikkely-ért     | tüzér-ért     | kétely-ért     | pehely-ért    | teher-ért    | kehely-ért    |
| SG     | TRANS   | pikkel-lyé      | tüzér-ré      | kétel-lyé      | pehel-lyé     | teher-ré     | kehel-lyé     |
...
| PL     | INS     | pikkely-ek-kel  | tüzér-ek-kel  | kétely-ek-kel  | pelyh-ek-kel  | terh-ek-kel  | kelyh-ek-kel  |
| PL     | PRP     | pikkely-ek-ért  | tüzér-ek-ért  | kétely-ek-ért  | pelyh-ek-ért  | terh-ek-ért  | kelyh-ek-ért  |
| PL     | TRANS   | pikkely-ek-ké   | tüzér-ek-ké   | kétely-ek-ké   | pelyh-ek-ké   | terh-ek-ké   | kelyh-ek-ké   |
